...
if((carregado==true) || (IE4))
{
 if(verifica==true)
 {
   if(Teste_vest1_atual == Teste_vest1_correta)
   {
   ...
   else
   {
       erros = erros + 1;
       if (somRevejaTeste!='') {
         somReveja=somRevejaTeste;
       }
       if (mensagem_tela_revejateste!='') {
         mensagem=mensagem_tela_revejateste;
       } else {
         mensagem='Reveja teste!';
       }
   }
   if (Teste_vest1_atual == -1) {
