...
{
  var monta_swf = '';
  monta_swf += "<object type=\"application/x-shockwave-flash\" data=\"player_mp3.swf\" width=\"0\" height=\"0\" align=\"right\">";
  monta_swf += "     <param name=\"movie\" value=\"player_mp3.swf\" />";
  if (loop==false)
    monta_swf += "     <param name=\"FlashVars\" value=\"mp3="+surl+"&amp;loop=0&amp;autoplay=1\" />";
  else
    monta_swf += "     <param name=\"FlashVars\" value=\"mp3="+surl+"&amp;loop=1&amp;autoplay=1\" />";
  monta_swf += "</object>";
  document.getElementById('somspan').innerHTML=monta_swf;
}
